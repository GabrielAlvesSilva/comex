...
public class ItemPedidoDAO {
	...
	public void atualizarItemPedidoQuantidade(int id, int novo) throws SQLException {
		 String sql = "update comex.item_pedido set quantidade = ? where id = ?";
		 
		 PreparedStatement update = connection.prepareStatement(sql);
		 	update.setInt(1, novo);
		 	update.setInt(2, id);
		 	update.execute();
